  ...
  return (
    ...
    <main className="flex justify-between align-middle w-full">
        <div className='flex h-[calc(100vh-11rem)] items-end w-[100%] md:w-[100%] xl:w-[80%]'>
            <p className='text-[2rem] leading-[1.8rem] sm:text-[2.5rem] sm:leading-[2.25rem] md:text-[3rem] md:leading-[2.5rem] lg:text-5xl lg:leading-[2.5rem] xl:text-6xl xl:leading-[3.35rem] font-marist pl-4' style={{ wordBreak: "normal", hyphens: "none" }}>
